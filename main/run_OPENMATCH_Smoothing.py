...
sys.path.append("./")
from configs import OPENMATCHSmoothingConfig
...
from tasks.classification_OPENMATCH_Smoothing import Classification
...
def main():
    ...
    config = OPENMATCHSmoothingConfig.parse_arguments()
    set_gpu(config)
