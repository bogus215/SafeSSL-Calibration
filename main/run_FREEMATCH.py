...
sys.path.append("./")
from configs import FREEMATCHConfig
...
from tasks.classification_FREEMATCH import Classification
...
def main():
    ...
    config = FREEMATCHConfig.parse_arguments()
    set_gpu(config)
...
def main_worker(local_rank: int, config: object):
    ...
    model.run(
        ...
        ema_p=config.ema_p,
        ent_loss_ratio=config.ent_loss_ratio,
