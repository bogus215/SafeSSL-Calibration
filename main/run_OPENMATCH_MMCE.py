...
sys.path.append("./")
from configs import OPENMATCHMMCEConfig
...
from tasks.classification_OPENMATCH_MMCE import Classification
...
def main():
    ...
    config = OPENMATCHMMCEConfig.parse_arguments()
    set_gpu(config)
...
def main_worker(local_rank: int, config: object):
    ...
    model.run(
        ...
        lambda_mmce=config.lambda_mmce,
