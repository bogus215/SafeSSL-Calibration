...
from datasets.svhn import SVHN, ACR, load_SVHN
...
def main_worker(local_rank: int, config: object):
    ...
    setattr(model,'fc1', nn.Linear(model.output.in_features, model.class_num, bias=False))
    ...
    if config.data in ['cifar10', 'cifar100']:
        ...
        labeled_set = ACR(labelset=datasets['l_train'], unlabelset=None, transform=train_trans, name='lb')
        unlabeled_set = ACR(labelset=datasets['l_train'], unlabelset=datasets['u_train'], name='ulb',transform=train_trans)
