...
sys.path.append("./")
from configs import OPENMATCHRankMixupConfig
...
from tasks.classification_OPENMATCH_RankMixup import Classification
...
def main():
    ...
    config = OPENMATCHRankMixupConfig.parse_arguments()
    set_gpu(config)
...
def main_worker(local_rank: int, config: object):
    ...
    model.run(
        ...
        mixup_alpha=config.alpha,
        num_mixup=config.num_mixup,
        mixup_coef=config.loss_coef,
