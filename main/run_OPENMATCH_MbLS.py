...
sys.path.append("./")
from configs import OPENMATCHMbLSConfig
...
from tasks.classification_OPENMATCH_MbLS import Classification
...
def main():
    ...
    config = OPENMATCHMbLSConfig.parse_arguments()
    set_gpu(config)
...
def main_worker(local_rank: int, config: object):
    ...
    model.run(
        ...
        mbls_margin=config.margin,
        mbls_coef=config.loss_coef,
        logger=logger,
    )
