...
def main_worker(local_rank: int, config: object):
    ...
    if config.data in ['cifar10', 'cifar100']:
        ...
        labeled_set = Selcted_DATA(dataset=datasets['l_train'], name='train_lb', transform=train_trans)
        unlabeled_set = Selcted_DATA(dataset=datasets['u_train'], name='train_ulb_selected',transform=train_trans)
