...
sys.path.append("./")
from configs import SIMMATCHConfig
...
from tasks.classification_SIMMATCH import Classification
...
def main():
    ...
    config = SIMMATCHConfig.parse_arguments()
    set_gpu(config)
...
def main_worker(local_rank: int, config: object):
    ...
    model.run(
        ...
        K=len(labeled_set),
        T=config.T,
        in_loss_ratio=config.in_loss_ratio,
        smoothing_alpha=config.smoothing_alpha,
        da_len=config.da_len,
