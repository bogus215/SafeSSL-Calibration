...
sys.path.append("./")
from configs import OPENMATCHMixupConfig
...
from tasks.classification_OPENMATCH_Mixup import Classification
...
def main():
    ...
    config = OPENMATCHMixupConfig.parse_arguments()
    set_gpu(config)
