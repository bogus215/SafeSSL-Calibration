...
do
    ...
    do
        echo WAD+CIFAR10, ${CIFAR10_SEEDS[$seed]}, $ratio
        python ./main/run_WAD.py --gpus 0 --seed ${CIFAR10_SEEDS[$seed]} \
        ...
        echo WAD+CIFAR100, ${CIFAR100_SEEDS[$seed]}, $ratio
        python ./main/run_WAD.py --gpus 0 --seed ${CIFAR100_SEEDS[$seed]} \
        ...
        echo WAD+TINY, ${TINY_SEEDS[$seed]}, $ratio
        python ./main/run_WAD.py --gpus 0 --seed ${TINY_SEEDS[$seed]} \
        ...
        echo WAD+SVHN, ${SVHN_SEEDS[$seed]}, $ratio
        python ./main/run_WAD.py --gpus 0 --seed ${SVHN_SEEDS[$seed]} \
