...
do
    ...
    do
        echo FIXMATCH+CIFAR10, ${CIFAR10_SEEDS[$seed]}, $ratio
        ...
        python ./main/run_SAFE_STUDENT.py --gpus 0 --seed ${CIFAR100_SEEDS[$seed]} \
        ...
        python ./main/run_SAFE_STUDENT.py --gpus 0 --seed ${TINY_SEEDS[$seed]} \
