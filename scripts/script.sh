# python ./main/run_SL.py --gpus 0 --data cifar100 --enable-wandb --server main --n-label-per-class 100 --n-valid-per-class 50 --mismatch-ratio 0.50 --mixed-precision --save-every 25000
...
for ratio in 0.00 0.25 0.50 0.75 1.00;
do
