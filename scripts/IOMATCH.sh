...
do
    ...
    do
        echo IOMATCH+CIFAR10, ${CIFAR10_SEEDS[$seed]}, $ratio
        ...
        echo IOMATCH+CIFAR100, ${CIFAR100_SEEDS[$seed]}, $ratio
        python ./main/run_IOMATCH.py --gpus 0 --seed ${CIFAR100_SEEDS[$seed]} \
        ...
        echo IOMATCH+TINY, ${TINY_SEEDS[$seed]}, $ratio
        python ./main/run_IOMATCH.py --gpus 0 --seed ${TINY_SEEDS[$seed]} \
        ...
        echo IOMATCH+SVHN, ${SVHN_SEEDS[$seed]}, $ratio
