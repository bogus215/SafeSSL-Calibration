...
class Classification(Task):
                ...
                with torch.cuda.amp.autocast(self.mixed_precision):
                    ...
                    if current_epoch >= start_fix:
                        ...
                        with torch.no_grad():
                            ...
                            ood_score = ((((self.backbone.scaling_logits(weak_ova_logit, name='ova_cali_scaler')).detach()).view(len(unlabel_weak_x),2,-1).softmax(1))[:,0,:] * unlabel_weak_softmax).sum(1)
    ...
    def evaluate(self, data_loader, n_bins, train_n_bins, **kwargs):
        ...
        with Progress(transient=True, auto_refresh=False) as pg:
            ...
            pred, unscaled_ova_pred, ova_pred, true = [], [], [], []
        ...
        unscaled_ova_preds = torch.cat(unscaled_ova_pred,axis=0)
