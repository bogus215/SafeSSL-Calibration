...
class Classification(Task):
    ...
    def run(self,
        ...
        for epoch in range(1, epochs + 1):
            ...
            # Train & evaluate
            train_history, cls_wise_results, train_l_iterator, train_u_iterator = self.train(train_l_iterator, train_u_iterator, iteration=save_every, tau=tau, cali_coef=cali_coef, smoothing_proposed=None if epoch==1 else ece_results, n_bins=n_bins)
    ...
    def train(self, label_iterator, unlabel_iterator, iteration, tau, cali_coef, smoothing_proposed, n_bins):
