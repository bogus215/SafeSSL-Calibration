...
class Classification(Task):
    ...
    def train(self, label_loader, unlabel_loader, current_epoch, start_fix, tau, lambda_ova_soft, lambda_ova, lambda_fix, n_bins):
                ...
                with torch.cuda.amp.autocast(self.mixed_precision):
                    ...
                    if current_epoch >= start_fix:
                        ...
                        with torch.no_grad():
                            ...
                            ood_score = ((weak_ova_logit.detach().view(len(unlabel_weak_x),2,-1).softmax(1))[:,0,:] * unlabel_weak_softmax).sum(1)
                    ...
                    loss = label_sup_loss + lambda_ova*label_ova_loss + lambda_ova_soft*ova_soft_loss + lambda_fix*fix_loss
