...
# This code includes references to 'https://github.com/weiaicunzai/pytorch-cifar100.git's work
...
class InceptionV4(nn.Module):
    ...
    def __init__(self, A, B, C, class_nums, k=192, l=224, m=256, n=384):
...
def inceptionv4(class_nums):
    return InceptionV4(4, 7, 3, class_nums)
